...
# Project Goal
I did the terraform usage and used terraform script to create a docker container.
...
`https://gitlab.example20221106.com/api/v4/projects/34/terraform/state/old-state-name`
...
![image](https://user-images.githubusercontent.com/75282285/206549260-ca052d48-9c5f-48ea-945d-33491f7b48f2.png)
...
```
![image](https://user-images.githubusercontent.com/75282285/206549501-6a4f9dda-9138-4d70-bcfd-2e374fd7b785.png)
...
[Terraform Setttings Backends http](https://developer.hashicorp.com/terraform/language/settings/backends/http)</br>) with the credential/gitlab server info accordingly. The below is the definition for the variables:</br>
